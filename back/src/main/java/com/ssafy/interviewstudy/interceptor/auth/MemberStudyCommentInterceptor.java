...
public class MemberStudyCommentInterceptor implements HandlerInterceptor {
    ...
    @Autowired
    public MemberStudyCommentInterceptor(StudyService studyService, MemberService memberService) {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        ...
        int commentId = pathVariables.get(2);
        ...
        Boolean isStudyMember = studyService.checkStudyMember(memberId,studyId);
        if(!isStudyMember){
